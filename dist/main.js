...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   fetchAndDisplayShows: () => (/* binding */ fetchAndDisplayShows)\n/* harmony export */ });\n/* harmony import */ var _Card__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Card */ \"./src/components/Card.js\");\n/* harmony import */ var _InvolvementAPI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./InvolvementAPI */ \"./src/components/InvolvementAPI.js\");\n\r\n\r\n\r\nconst API_URL = 'https://api.tvmaze.com/shows';\r\n\r\nasync function fetchAndDisplayShows() {\r\n  fetch(API_URL)\r\n    .then(response => response.json())\r\n    .then(async data => {\r\n      const showList = document.getElementById('showList');\r\n      const totalItems = document.getElementById('totalItems');\r\n\r\n      totalItems.textContent = `Total Shows: ${data.length}`;\r\n\r\n      const likesData = await (0,_InvolvementAPI__WEBPACK_IMPORTED_MODULE_1__.getLikes)(); // Fetch initial likes data\r\n\r\n      data.forEach(show => {\r\n        const showLikes = likesData.find(item => item.item_id === show.id);\r\n        const card = (0,_Card__WEBPACK_IMPORTED_MODULE_0__.createCard)(show, showLikes ? showLikes.likes : 0);\r\n\r\n        const likeButton = card.querySelector('.like-button');\r\n\r\n        likeButton.addEventListener('click', async () => {\r\n          const success = await (0,_InvolvementAPI__WEBPACK_IMPORTED_MODULE_1__.recordLike)(show.id);\r\n          if (success) {\r\n            const updatedLikesData = await (0,_InvolvementAPI__WEBPACK_IMPORTED_MODULE_1__.getLikes)();\r\n            const updatedShowLikes = updatedLikesData.find(item => item.item_id === show.id);\r\n            if (updatedShowLikes) {\r\n              likeButton.textContent = `❤️ Like (${updatedShowLikes.likes})`; // Update like count on click\r\n            }\r\n          }\r\n        });\r\n\r\n        showList.appendChild(card);\r\n      });\r\n    });\r\n}\r\n\n\n//# sourceURL=webpack://capstone-api-based-webapp/./src/components/MovieList.js?");
